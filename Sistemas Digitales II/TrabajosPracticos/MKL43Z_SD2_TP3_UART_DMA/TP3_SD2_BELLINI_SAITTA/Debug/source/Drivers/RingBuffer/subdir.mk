...
C_SRCS += \
../source/Drivers/RingBuffer/ringBuffer.c 

C_DEPS += \
./source/Drivers/RingBuffer/ringBuffer.d 

OBJS += \
./source/Drivers/RingBuffer/ringBuffer.o 


# Each subdirectory must supply rules for building sources it contributes
source/Drivers/RingBuffer/%.o: ../source/Drivers/RingBuffer/%.c source/Drivers/RingBuffer/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-Drivers-2f-RingBuffer

clean-source-2f-Drivers-2f-RingBuffer:
	-$(RM) ./source/Drivers/RingBuffer/ringBuffer.d ./source/Drivers/RingBuffer/ringBuffer.o

.PHONY: clean-source-2f-Drivers-2f-RingBuffer
