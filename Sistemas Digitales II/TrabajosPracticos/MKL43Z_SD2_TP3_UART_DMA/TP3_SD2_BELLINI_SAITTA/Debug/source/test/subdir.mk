...
C_SRCS += \
../source/test/test_trama_process.c 

C_DEPS += \
./source/test/test_trama_process.d 

OBJS += \
./source/test/test_trama_process.o 


# Each subdirectory must supply rules for building sources it contributes
source/test/%.o: ../source/test/%.c source/test/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-test

clean-source-2f-test:
	-$(RM) ./source/test/test_trama_process.d ./source/test/test_trama_process.o

.PHONY: clean-source-2f-test
