...
C_SRCS += \
../source/Drivers/Key/key.c 

C_DEPS += \
./source/Drivers/Key/key.d 

OBJS += \
./source/Drivers/Key/key.o 


# Each subdirectory must supply rules for building sources it contributes
source/Drivers/Key/%.o: ../source/Drivers/Key/%.c source/Drivers/Key/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-Drivers-2f-Key

clean-source-2f-Drivers-2f-Key:
	-$(RM) ./source/Drivers/Key/key.d ./source/Drivers/Key/key.o

.PHONY: clean-source-2f-Drivers-2f-Key
