...
#define LED_ROJO_PIN 		29	    //Pin del LED ROJO
...
#define LED_ROJO_MODE 		PORTE->PCR[29] 	                    |= PORT_PCR_MUX(1) // 10-8 es el MUX y para GPIO debe ponerse 001
#define LED_ROJO_OUTPUT		PTE->PDDR      						|= 1<<29
